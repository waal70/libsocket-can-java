...
JNIEXPORT jint JNICALL Java_org_waal70_canbus_CanSocket__1setEFFSFF
(JNIEnv *env, jclass obj, jint canid)
{
	return canid | CAN_EFF_FLAG;
}

JNIEXPORT jint JNICALL Java_org_waal70_canbus_CanSocket__1setRTR
(JNIEnv *env, jclass obj, jint canid)
{
	return canid | CAN_RTR_FLAG;
}

JNIEXPORT jint JNICALL Java_org_waal70_canbus_CanSocket__1setERR
(JNIEnv *env, jclass obj, jint canid)
{
...
JNIEXPORT jint JNICALL Java_org_waal70_canbus_CanSocket__1clearRTR
(JNIEnv *env, jclass obj, jint canid)
{
	return canid & ~CAN_RTR_FLAG;
}

JNIEXPORT jint JNICALL Java_org_waal70_canbus_CanSocket__1clearERR
(JNIEnv *env, jclass obj, jint canid)
{
	return canid & ~CAN_ERR_FLAG;
}
